...
| 6d-iter-align-ext | running | 1 | `dense80_depthc_ia.yaml` | `experiments/runs/6d-iter-align.md` | iter_align 全物体验证（cat/holepuncher/can）+ 迭代轮数消融（iters 1/2/3）| 任一物体 ADD ≥ 基线 +3 且无崩溃 | duck/ape 已通过（+16.67/+11.67）；can 基线需同口径新跑 |

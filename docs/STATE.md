...
| 项 | 说明 |
|---|---|
| 6d-refviews（在跑 08-17）| 3DGS 训练参考视图数 64→128 隔离探针：30k 实验混杂迭代数与视图数（保留 3 物体=30k+128v，其余 10 物体=旧世代 7000/64v 无 train_fp）；cat 7000/128v 现代配方 vs 基线 64.17，成功线 +3 扩 9 物体重训全量验证；bank 已备份 .viewsbak；评测用全新 cache |

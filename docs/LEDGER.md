...
| dense80_depthc_ia_geocand.yaml | running | 6d-mask-geo 掩码几何平移候选（champion + solver.mask_geo_candidate: true）：GS-Pose §3.2 面积比 z + 质心 xy 解析平移，与 PnP 结果 align_loss 竞争择优；对症失败帧 48.5% 纯 t 错 |
